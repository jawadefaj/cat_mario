...
def capture_cat_mario(program_name):
    ...
    def map_matrix(matrix, cat_pos, background_ini_index, platform_ini_index, enemy_ini_index):
        ...
        for row in range(len(matrix)):
            ...
            new_matrix_encode.append(new_row_list)
        return new_matrix, new_matrix_encode
    ...
    matrix_out, matrix_out_encode = map_matrix(class_matrix, (6,4), 0, 3, 8)
    ...
    return game_bgr, cat_view_bgr, matrix_out_encode, matrix_img, game_corners, death_out
